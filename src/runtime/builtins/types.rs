...
use crate::{
    ...
    runtime::{
        FunctionValue, LuaValue, RuntimeValue, TYPE_NAME_FIELD, TYPE_TAG_FIELD, TYPE_TRAITS_FIELD,
...
impl BuiltinType {
    ...
    fn prepare_field_tables(&self, l: LuaState) {
        ...
        push_table(l, 0, self.traits.len() as i32);
        for tr in self.traits {
            push_bool(l, true);
            set_field(l, -2, tr.name);
        }
        set_field(l, -2, TYPE_TRAITS_FIELD);
